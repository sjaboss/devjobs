        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                @auth
                    ...
                    @can('create', App\Models\Vacante::class)
                        <a class="mr-2 w-7 h-7 bg-indigo-600 hover:bg-indigo-800 text-white rounded-full flex flex-col justify-center items-center font-bold "
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        @auth
            ...
            <div class="flex flex-col gap-2 items-center p-3">
                {{--  @if (auth()->user()->rol === 2) --}}
                <a class=" w-7 h-7 bg-indigo-600 hover:bg-indigo-800 text-white rounded-full flex flex-col justify-center items-center font-bold "
                    href="{{ route('notificaciones') }}">
                    {{ auth()->user()->unreadNotifications->count() }}
                </a>
